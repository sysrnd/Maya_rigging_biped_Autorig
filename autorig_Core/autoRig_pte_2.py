...
class autoRig_02():
	...
	def principal(self):
		...
		lista_01 = ['DRIVER_CUELLO','DRIVER_ROOT','DRIVER_COLUMNA_TOP','DRIVER_ROOT']
		...
		self.multi(conexion = 'pac', lst_01 =['CABEZA_INUTIL','DRIVER_ROOT'], lst_02 =['GRP_DRIVER_OJOS','GRP_DRIVER_OJOS'], lst_03 =['PARENT_CONSTRAIN_OJOS','PARENT_CONSTRAIN_OJOS'])
		
		lista_01 = ['CABEZA_INUTIL','CABEZA_INUTIL','DRIVER_ROOT','DRIVER_ROOT']
		...
		self.multi(conexion = 'set', lst_01 = lista_01, lst_02 =['DRIVER_ROOTW1','DRIVER_ROOTW1','DRIVER_ROOTW1','DRIVER_ROOTW1','DRIVER_ROOTW1'], attr=1)


		self.multi(conexion = 'sdk', lst_01 = ['PARENT_CONSTRAIN_OJOS','PARENT_CONSTRAIN_OJOS'], lst_02 =['CABEZA_INUTILW0','DRIVER_ROOTW1'], solver='DRIVER_CABEZA.SWITCH_OJOS')
		self.multi(conexion = 'sdk', lst_01 = ['PARENT_CONSTRAIN_CABEZA_ROTATE','PARENT_CONSTRAIN_CABEZA_ROTATE'], lst_02 =['DRIVER_CUELLOW0','DRIVER_ROOTW1'], solver='DRIVER_CABEZA.SWITCH_CABEZA_FOLLOW')
		self.multi(conexion = 'sdk', lst_01 = ['PARENT_CONSTRAIN_CUELLO_ROTATE','PARENT_CONSTRAIN_CUELLO_ROTATE'], lst_02 =['DRIVER_COLUMNA_TOPW0','DRIVER_ROOTW1'], solver='DRIVER_CUELLO.SWITCH_CUELLO_FOLLOW')
		self.multi(conexion = 'sdk', lst_01 = ['PARENT_CONSTRAIN_LENTES','PARENT_CONSTRAIN_LENTES'], lst_02 =['CABEZA_INUTILW0','DRIVER_ROOTW1'], solver='DRIVER_CABEZA.SWITCH_LENTES')
		self.multi(conexion = 'sdk', lst_01 = ['PARENT_CONSTRAIN_SOMBRERO','PARENT_CONSTRAIN_SOMBRERO'], lst_02 =['CABEZA_INUTILW0','DRIVER_ROOTW1'], solver='DRIVER_CABEZA.SWITCH_SOMBRERO')
		...
		lista_01 = ['PARENT_CONSTRAIN_CABEZA_ROTATE','PARENT_CONSTRAIN_CUELLO_ROTATE','PARENT_CONSTRAIN_OJOS','PARENT_CONSTRAIN_LENTES','PARENT_CONSTRAIN_SOMBRERO']
		lista_02 = ['DRIVER_ROOTW1','DRIVER_ROOTW1','DRIVER_ROOTW1','DRIVER_ROOTW1','DRIVER_ROOTW1']
		...
		self.multi(conexion='p', lst_01=['LOCATOR_LEGS_2_IZQ'], lst_02=['GRP_STRECH_PIERNAS'])
