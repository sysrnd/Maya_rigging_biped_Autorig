...
cmds.select('BOCA_ABIERTA_SONRISA_BS', 'BOCA_F_BS', 'BOCA_E_BS', 'BOCA_A_BS', 'BOCA_I_BS', 'BOCA_U_BS', 'BOCA_O_BS', 'BOCA_M_BS', 'BOCA_BESO_BS', 'BOCA_CHICA_BS',
...
cmds.select('CEJAS_WRAP_MD', 'CEJAS_MD')
...
cmds.setAttr('BLEND_CEJAS.CEJAS_WRAP_MD', 1)
...
cmds.connectAttr( 'DRIVER_CARA.TRISTE_BS', 'BLEND_GENERAL.TRISTE_BS' )
cmds.connectAttr( 'DRIVER_CARA.ENOJADO_BS', 'BLEND_GENERAL.ENOJADO_BS' )
cmds.connectAttr( 'DRIVER_CARA.SORPRENDIDO_BS', 'BLEND_GENERAL.SORPRENDIDO_BS' )
cmds.connectAttr( 'DRIVER_CARA.STRETCH_BS', 'BLEND_GENERAL.STRETCH_BS' )
cmds.connectAttr( 'DRIVER_CARA.SQUASH_BS', 'BLEND_GENERAL.SQUASH_BS' )

cmds.connectAttr( 'CEJAS.CEJAS_ENOJADAS_BS', 'BLEND_GENERAL.CEJAS_ENOJADAS_BS' )
cmds.connectAttr( 'CEJAS.CEJAS_TRISTES_BS', 'BLEND_GENERAL.CEJAS_TRISTES_BS' )

cmds.connectAttr( 'EXTRAS.CENO_ENOJADO_BS', 'BLEND_GENERAL.CENO_ENOJADO_BS' )
cmds.connectAttr( 'EXTRAS.CACHETE_INFLADO_IZQ_BS', 'BLEND_GENERAL.CACHETE_INFLADO_IZQ_BS' )
cmds.connectAttr( 'EXTRAS.CACHETE_INFLADO_DER_BS', 'BLEND_GENERAL.CACHETE_INFLADO_DER_BS' )
...
cmds.connectAttr( 'EXTRAS.VACIO1_BS', 'BLEND_GENERAL.VACIO1_BS' )
cmds.connectAttr( 'EXTRAS.VACIO2_BS', 'BLEND_GENERAL.VACIO2_BS' )
cmds.connectAttr( 'EXTRAS.VACIO3_BS', 'BLEND_GENERAL.VACIO3_BS' )
cmds.connectAttr( 'EXTRAS.VACIO4_BS', 'BLEND_GENERAL.VACIO4_BS' )


cmds.connectAttr( 'BOCA.BOCA_E_BS', 'BLEND_GENERAL.BOCA_E_BS' )
cmds.connectAttr( 'BOCA.BOCA_A_BS', 'BLEND_GENERAL.BOCA_A_BS' )
cmds.connectAttr( 'BOCA.BOCA_I_BS', 'BLEND_GENERAL.BOCA_I_BS' )
cmds.connectAttr( 'BOCA.BOCA_U_BS', 'BLEND_GENERAL.BOCA_U_BS' )
cmds.connectAttr( 'BOCA.BOCA_F_BS', 'BLEND_GENERAL.BOCA_F_BS' )
cmds.connectAttr( 'BOCA.BOCA_O_BS', 'BLEND_GENERAL.BOCA_O_BS' )
cmds.connectAttr( 'BOCA.BOCA_M_BS', 'BLEND_GENERAL.BOCA_M_BS' )
cmds.connectAttr( 'BOCA.BOCA_BESO_BS', 'BLEND_GENERAL.BOCA_BESO_BS' )
cmds.connectAttr( 'BOCA.BOCA_CHICA_BS', 'BLEND_GENERAL.BOCA_CHICA_BS' )
cmds.connectAttr( 'BOCA.BOCA_SMIRK_DER_BS', 'BLEND_GENERAL.BOCA_SMIRK_DER_BS' )
cmds.connectAttr( 'BOCA.BOCA_SMIRK_IZQ_BS', 'BLEND_GENERAL.BOCA_SMIRK_IZQ_BS' )
cmds.connectAttr( 'BOCA.FELIZ_BS', 'BLEND_GENERAL.FELIZ_BS' )
cmds.connectAttr( 'BOCA.BOCA_ABIERTA_SONRISA_BS', 'BLEND_GENERAL.BOCA_ABIERTA_SONRISA_BS' )
...
cmds.editDisplayLayerMembers( 'no_tocar', 'IK_BRAZO_IZQ', 'IK_BRAZO_DER', 'IK_TALON_IZQ', 'IK_TALON_DER',
 	'IK_PIE_IZQ', 'IK_PIE_DER', 'IK_DEDOS_PIE_IZQ', 'IK_DEDOS_PIE_DER', 'CLR_CODO_IZQ_1', 'CLR_CODO_IZQ_2',
  	...
  	'CLR_RODILLA_IZQ_2', 'CLR_RODILLA_DER_2', 'BOCA_ABIERTA_SONRISA_BS', 'BOCA_F_BS', 'BOCA_E_BS', 'BOCA_A_BS', 'BOCA_I_BS', 'BOCA_U_BS', 'BOCA_O_BS',
  	...
  	'VACIO3_BS', 'VACIO4_BS','WIRE_BS','ROOT_BS', 'CEJAS_WRAP_MD','ROOT_BSBase', 'DEFORM_CURV_DER','DEFORM_CURV_DERBaseWire', 
